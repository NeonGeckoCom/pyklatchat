...
docker run --rm -d --name chat-server -e PORT=8010 -e HOST=0.0.0.0 -p 8010:8010 --mount source=pyklatchat-static-media,destination=/app/static neon/chat_server:latest
